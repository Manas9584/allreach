  ...
  !(function () {
    ...
    (n = {
      ...
      defer: function (n) {
        ...
        return (
          ...
          e.features.has.promises
            ...
            : (o = t.jQuery || n.Rs) && "function" == typeof o.Deferred
            ? ((a = o.Deferred()),
              (i.promise = a.promise()),
              (i.resolve = a.resolve),
              (i.reject = a.reject))
      ...
      all: function (n, a) {
        ...
        return e.features.has.promises
          ? Promise.all(n)
          : (i = t.jQuery || a.Rs) && "function" == typeof i.when
    ...
    (e.Config = function () {
      e.Base.call(this),
        ...
        (this.selecto$ = new e.ConfigSelectors()),
